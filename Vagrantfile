...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "klemen-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/design_collective"
  #   chef.validation_client_name = "design_collective-validator"
  #   chef.validation_key_path = ".chef/design_collective-validator.pem"
  # end
end
